    ...
    if ($this->session->flashdata('error')) {
					...
					<div class="card ">
						<div class="card-body pb-10">
							<div class="row">
								<div class="col-md-12">
									<form method="post" action="<?=base_url('fs');?>" id="report_form">
                                    ...
                                    <div class="col-xl-2 col-md-2 col-lg-2 col-sm-12 col-12">
													...
													<div class="form-group">
														...
														<input class="form-check-input" name="fs_type" value="custom" type="radio" checked>
                                                ...
                                                <div class="form-group">
														...
														<input class="form-check-input" name="fs_type" value="comparative"  type="radio">
                                                        <label class="form-check-label" for="gender_male">
															Comparative
															</label>
													</div>
                            ...
                            <div class="row pt-10">
                                        <div class="col-md-3 col-lg-3 col-sm-12">
                                                    <button type="submit" class="btn btn-primary" id="generate_tb">
                                                         Generate report
                                                    </button>
                                                </div>
                                                <div class="col-md-3 col-lg-3 col-sm-12">
                                                    <button type="button" class="btn btn-outline-primary" id="preview_report_btn" data-preview-url="<?=base_url('fs_preview');?>">
                                                         Preview report
                                                    </button>
                                                </div>
                                                <div class="col-md-3 col-lg-3 col-sm-12">
                                                    <button type="button" class="btn btn-outline-secondary d-none report-preview-pdf-btn" id="preview_pdf_btn" data-preview-url="<?=base_url('fs_preview');?>">
                                                         Preview PDF
                                                    </button>
                                                </div>
                                                </form>
