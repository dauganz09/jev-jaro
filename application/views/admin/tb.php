    ...
    if ($this->session->flashdata('error')) {
					...
					<div class="card ">
						<div class="card-body pb-10">
							<div class="row">
								<div class="col-md-12">
									<form method="post" action="<?=base_url('tb');?>" id="report_form">
                            ...
                            <div class="row pt-10">
                                        <div class="col-md-3 col-lg-3 col-sm-12">
                                                ...
                                                <div class="col-md-3 col-lg-3 col-sm-12">
                                                    <button type="button" class="btn btn-outline-primary" id="preview_report_btn" data-preview-url="<?=base_url('tb_preview');?>">
                                                         Preview report
                                                    </button>
                                                </div>
                                                </form>
