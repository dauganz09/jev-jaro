						...
						<div class="card-body pb-10">
								...
								<div class="col-md-12">
                                    ...
                                    <div class="row ">
                                        ...
                                        <label for="">Journal Type:</label>
                                                    <select class="form-control" name="j_type"  id="j_type">
                            ...
                            <div class="row pt-10">
                                        <div class="col-md-3 col-lg-3 col-sm-12">
                                                ...
                                                <div class="col-md-3 col-lg-3 col-sm-12">
                                                    <button type="button" class="btn btn-outline-secondary d-none report-preview-pdf-btn" id="preview_pdf_btn" data-preview-url="<?=base_url('gj_preview');?>">
                                                         Preview PDF
                                                    </button>
                                                </div>
                                                </form>
