    ...
    if ($this->session->flashdata('error')) {
					...
					<div class="card ">
						<div class="card-body pb-10">
							<div class="row">
								<div class="col-md-12">
									<form method="post" action="<?=base_url('sba');?>">
                                    ...
                                    <div class="row ">
                                        ...
                                        <h2>Statement of Comparison of Budget and Actual Amounts</h2>
                                    </div>
                            ...
                            <div class="row pt-10">
                                        <div class="col-md-3 col-lg-3 col-sm-12">
                                                    <button type="submit" class="btn btn-primary" id="generate_sba">
                                                         Generate report
                                                    </button>
                                                </div>
                                                </form>
